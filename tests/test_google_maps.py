...
class TestGoogleMaps:
    ...
    réaliser un mock de l'api:
    elle doit retouner un dictionnaore de données


    def test_request_get(self, address)
    mock de la méthode request_get qui doit récupérer les données nécessaires à partir du dictionnaire de l'api